...
### - [x] BUG-P2-010: 前端错误处理 - API 错误未区分类型
...
### - [x] BUG-P2-011: 代码重复 - 多处定义 Exception 类
...
### - [x] BUG-P2-013: 测试覆盖率低 - 核心业务逻辑缺少单元测试
...
### - [x] BUG-P2-014: Electron IPC 未校验输入 - 潜在注入风险
